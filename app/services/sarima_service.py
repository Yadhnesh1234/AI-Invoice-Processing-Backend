...
def get_forecast_preprocess(stock_code=None, freq="W", periods=20):
    ...
    for prod_id in stock_codes:  
        ...
        new_ts2 = new_ts[d_range_s:d_range_e].resample(freq).max()  # Resample based on freq
        new_ts3 = new_ts[d_range_s:d_range_e].resample(freq).mean()  # Resample based on freq
